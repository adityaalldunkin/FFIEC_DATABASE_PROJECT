...
## MDRM-enriched loan exports (Federal Reserve dictionary)

Generated by `python extract_texas_loans.py` using [MDRM_CSV.csv](https://www.federalreserve.gov/apps/mdrm/pdf/MDRM.zip):

| File | Description |
|------|-------------|
| `exports/texas_loans_summary.csv` | Main loan category lines with `item_name` + `mdrm_description` |
| `exports/texas_loans_labeled.csv` | All loan/RC-C related facts with MDRM labels |
| `exports/texas_loan_products_mdrm_catalog.csv` | Code book of loan/lease MDRM definitions |
...
| `data/mdrm/MDRM_CSV.csv` | Federal Reserve MDRM dictionary (local copy) |
